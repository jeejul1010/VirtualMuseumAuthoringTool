...
namespace Oculus.Interaction
{
    public class GrabInteractor : PointerInteractor<GrabInteractor, GrabInteractable>, IRigidbodyRef
    {
        ...
        protected override void InteractableSelected(GrabInteractable interactable)
        {
            ...
            // // Disable collisions between the selected interactable and the player controller collider
            // int playerLayer = LayerMask.NameToLayer("Player");
            // int interactableLayer = interactable.gameObject.layer;
        ...
        protected override void InteractableUnselected(GrabInteractable interactable)
        {
            ...
            // // Re-enable collisions between the interactable and the player controller collider
            // int playerLayer = LayerMask.NameToLayer("Player");
            // int interactableLayer = interactable.gameObject.layer;
            // Physics.IgnoreLayerCollision(interactableLayer, playerLayer, false);
        }
